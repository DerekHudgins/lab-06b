...
app.get('/music/:id', async(req, res) => {
  try {
    const data = await client.query('SELECT * from music where id=$1', [req.params.id]);
...
app.post('/music', async(req, res) => {
  try {
    ...
    const data = await client.query(`
      ...
      VALUES ($1, $2, $3, $4, 1)
      RETURNING *`, [req.body.name, req.body.description, req.body.category, req.body.price]);
...
app.put('/music/:id', async(req, res) => {
  try {
    ...
    SET 
      ...
      price=$4
    WHERE id=$5
    RETURNING *`, [req.body.name, req.body.description, req.body.category, req.body.price, req.params.id]);
    res.json(data.rows[0]);
  } catch(e) {
